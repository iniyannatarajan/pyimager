...
pkg_canonicalize("Common" _pkg)
string(TOLOWER "Common" _lpkg)
...
set(_svn_tmp "/scratch/software/src/pyimager/build/gnu_opt/LCS/Common/version.svn.tmp")
execute_process(COMMAND /usr/bin/svn info /scratch/software/src/pyimager/LCS/Common
...
if(_result EQUAL 0)
  ...
  execute_process(COMMAND /usr/bin/svn status -q /scratch/software/src/pyimager/LCS/Common
    COMMAND grep -c "^[ADMR]"
...
set(_file "/scratch/software/src/pyimager/build/gnu_opt/include/Package__Version/Common/Package__Version.h")
...
# first create a temporary file; only copy it if files are different.
set(_file "/scratch/software/src/pyimager/build/gnu_opt/LCS/Common/src/Package__Version.cc")
file(WRITE "${_file}.tmp"
  "//# Get revision info for package Common; generated by CMake\n"
  "\n"
...
# first create a temporary file; only copy it if files are different.
set(_file "/scratch/software/src/pyimager/build/gnu_opt/LCS/Common/src/version${_lpkg}.cc")
file(WRITE "${_file}.tmp"
  "//# Print revision info for package Common; generated by CMake\n"
  "\n"
  "#include <Common/Package__Version.h>\n"
  "#include <Common/Version.h>\n"
  "#include <iostream>\n"
  ...
  "    type = argv[1];\n"
  "  }\n"
  "  Version::show<${_pkg}Version> (std::cout, \"Common\", type);\n"
  "  return 0;\n"
  "}\n")
execute_process(COMMAND "/usr/bin/cmake" -E 
  copy_if_different "${_file}.tmp" "${_file}")
