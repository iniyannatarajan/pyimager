...
pkg_canonicalize("pytools" _pkg)
string(TOLOWER "pytools" _lpkg)
...
set(_svn_tmp "/scratch/software/src/pyimager/build/gnu_opt/LCS/pytools/version.svn.tmp")
execute_process(COMMAND /usr/bin/svn info /scratch/software/src/pyimager/LCS/pytools
...
if(_result EQUAL 0)
  ...
  execute_process(COMMAND /usr/bin/svn status -q /scratch/software/src/pyimager/LCS/pytools
    COMMAND grep -c "^[ADMR]"
...
set(_file "/scratch/software/src/pyimager/build/gnu_opt/include/Package__Version/pytools/Package__Version.h")
...
# first create a temporary file; only copy it if files are different.
set(_file "/scratch/software/src/pyimager/build/gnu_opt/LCS/pytools/src/Package__Version.cc")
file(WRITE "${_file}.tmp"
  "//# Get revision info for package pytools; generated by CMake\n"
  "\n"
...
# first create a temporary file; only copy it if files are different.
set(_file "/scratch/software/src/pyimager/build/gnu_opt/LCS/pytools/src/version${_lpkg}.cc")
file(WRITE "${_file}.tmp"
  ...
  "    type = argv[1];\n"
  "  }\n"
  "  Version::show<${_pkg}Version> (std::cout, \"pytools\", type);\n"
  "  return 0;\n"
  "}\n")
execute_process(COMMAND "/usr/bin/cmake" -E 
  copy_if_different "${_file}.tmp" "${_file}")
