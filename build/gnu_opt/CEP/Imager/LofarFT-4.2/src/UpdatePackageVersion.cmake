...
pkg_canonicalize("LofarFT" _pkg)
string(TOLOWER "LofarFT" _lpkg)
...
set(_svn_tmp "/scratch/software/src/pyimager/build/gnu_opt/CEP/Imager/LofarFT-4.2/version.svn.tmp")
execute_process(COMMAND /usr/bin/svn info /scratch/software/src/pyimager/CEP/Imager/LofarFT-4.2
...
if(_result EQUAL 0)
  ...
  execute_process(COMMAND /usr/bin/svn status -q /scratch/software/src/pyimager/CEP/Imager/LofarFT-4.2
    COMMAND grep -c "^[ADMR]"
...
set(_file "/scratch/software/src/pyimager/build/gnu_opt/include/Package__Version/LofarFT/Package__Version.h")
...
# first create a temporary file; only copy it if files are different.
set(_file "/scratch/software/src/pyimager/build/gnu_opt/CEP/Imager/LofarFT-4.2/src/Package__Version.cc")
file(WRITE "${_file}.tmp"
  "//# Get revision info for package LofarFT; generated by CMake\n"
  "\n"
  "#include <LofarFT/Package__Version.h>\n"
  "#include <Common/Version.h>\n")
foreach(_dep Common;ParmDB;StationResponse)
  file(APPEND "${_file}.tmp"
    "#include <${_dep}/Package__Version.h>\n")
endforeach(_dep Common;ParmDB;StationResponse)
file(APPEND "${_file}.tmp"
  "\n"
  "namespace LOFAR {\n"
...
# first create a temporary file; only copy it if files are different.
set(_file "/scratch/software/src/pyimager/build/gnu_opt/CEP/Imager/LofarFT-4.2/src/version${_lpkg}.cc")
file(WRITE "${_file}.tmp"
  ...
  "    type = argv[1];\n"
  "  }\n"
  "  Version::show<${_pkg}Version> (std::cout, \"LofarFT\", type);\n"
  "  return 0;\n"
  "}\n")
execute_process(COMMAND "/usr/bin/cmake" -E 
  copy_if_different "${_file}.tmp" "${_file}")
